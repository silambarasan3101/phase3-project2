...
namespace Application_to_Manage_Data_for_School_Application.Controllers
{
    public class SubjectsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "subject_id,subject_name,class_id")] Subject subject)
        {
            ...
            ViewBag.class_id = new SelectList(db.Classes, "class_id", "class_name", subject.class_id);
            return View(subject);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "subject_id,subject_name,class_id")] Subject subject)
        {
            if (ModelState.IsValid)
            {
